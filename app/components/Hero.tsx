...
import BlueArrow from "../../public/assets/arrow.png"
...
export function Hero() {
    return (
        <div className="pt-4 lg:pt-100">
            <div className="px[20px] lg:px-[288px]">
              <h1 className="text-center text-[32px] leading-[40px] font-medium text-[#172026] lg: text-[64px] lg:leading-[72px]"> Start monitoring your websites like a pro</h1>       
                <p className="text-center pt-6 text-[#36485C] lg:text-[18px] lg:leading-7"> 
                    Get a birds eye view with our customizable dashboard. Stay on top of things!
            ...
            <div className="relative flex h-full w-full justify-center">
              ...
              <Image src={Gradient} alt="gradient" className="min-h-[500px] w-full object-cover lg:h-auto" />
                ...
                <div className="absolute botttom-5 flex w-full flex-col items-center">
